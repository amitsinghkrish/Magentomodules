<?php
namespace Training\Blog\Block\Adminhtml\Blog;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Training_Blog';
        $this->_controller = 'adminhtml_blog';

        parent::_construct();

        if ($this->_isAllowedAction('Training_Blog::save')) {
        ...
        if ($this->_isAllowedAction('Training_Blog::post_delete')) {
