...
namespace Training\Customrouter\Controller;
...
class Router implements \Magento\Framework\App\RouterInterface {
    ...
    public function match(\Magento\Framework\App\RequestInterface $request) {
        ...
        } else if(strpos($identifier, 'customrouter/type') !== false) {
            /*
             * We must set module, controller path and action name for our controller class(Controller/Test/Test.php)
             */
            $request->setModuleName('customrouter')->setControllerName('test')->setActionName('typetest');
        }
        else if(strpos($identifier, 'customrouter') !== false) {
            /*
             * We must set module, controller path and action name for our controller class(Controller/Test/Test.php)
             */
